...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        if (isValid) {
            ...
            const formspreeEndpoint = 'https://formspree.io/f/xaqkkgdd';
            ...
            fetch(formspreeEndpoint, {
                ...
                .catch(error => {
                    showFormStatus('error', 'Oops! There was a network error. Please try again.');
                })
                .finally(() => {
...
// Focus management handled via CSS :focus-visible
...
// Track outline position for trailing effect
let outlineX = 0;
let outlineY = 0;
